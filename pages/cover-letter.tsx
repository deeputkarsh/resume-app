...
function CoverLetter() {
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.salutation}>Hi,</div>
			<div className={styles.intro}>I am writing to express my interest in the {jobListingName} role currently available at your company. Having recently moved to Canada from India on an open work permit, I am looking for a job to build on my experience in the software industry of more than six years. I am well-versed in cloud architecture, security, and compliance because I have worked on numerous AWS projects, including migration, deployment, and maintenance. My AWS certifications also demonstrate my expertise in cloud platforms. I am confident that my skills and knowledge can contribute to the success of the company&apos;s cloud initiatives.</div>
			<div className={styles.body}>In my current role as a DevOps Lead, I have led the digital transformation of my current organization. When I joined the organization we had 3 EC2 instances and there was no CICD setup, deployments were manually done on the instances. Now we have more than 250 CodePipelines with over 100 executions daily, we have almost 650 lambda functions created using serverless framework used for REST APIs, 30 plus docker containers running on ECS Fargate with near zero downtime and deployments using Codedeploy blue-green deployments. We use AWS CDK with typescript to manage all of our infrastructure as code, from codepipelines to VPC. When we expanded to the UAE, we had to set up all of our infrastructure in the UAE region for data residency and GDPR compliance. I have led teams of developers and engineers, and helped set up best practices.</div>
